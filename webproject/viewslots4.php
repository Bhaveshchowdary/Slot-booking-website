...
<html>
    ...
    <h1><span class="slotheading">Booked Slots</span>:-</h1>
        ...
        <?php 
            ...
            $sql = "SELECT Slottime,Name,contactno,roomno FROM slotsdata4 WHERE Slotstatus = 1;";
        ...
        <?php 
            ...
            $sql = "SELECT Slottime,Name,contactno,roomno FROM slotsdata4 WHERE Slotstatus = 0;";
            $result = $conn->query($sql);
